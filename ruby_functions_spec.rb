...
class Functions_Practice < MiniTest::Test
  ...
  #please note = I rounded down volume with .floor to avoid hugely long float in test! Sorry for commenting...
  def test_volume_of_sphere()
    radius = 3
    volume = sphere_vol(radius)
    assert_equal(113, volume.floor)
